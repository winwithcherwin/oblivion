...
kubectl create --dry-run=client -n kube-system configmap oblivion-ca-certificate --from-file=certificate=.secrets/pki/root/oblivion-ca.crt -o yaml > kubernetes/apps/serviceaccounts-app/base/certificates/oblivion-ca-certificate.yaml
